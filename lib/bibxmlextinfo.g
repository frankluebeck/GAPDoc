...
[ rec(
      ...
      article := [ "author", "title", "journal", "year", "volume", 
          ...
          "url", "optional", "doi", "optional", "category", "optional", "other", "repeated" ],
      ...
      inbook := 
       [ [ "author", "or", "editor" ], "title", [ [ "chapter", "pages", 
          ...
          "optional", "url", "optional", "doi", "optional", "category", "optional", "other", 
          "repeated" ],
      ...
      mastersthesis := 
       [ "author", "title", "school", "year", "type", "optional", "address", 
          ...
          "optional", "size", "optional", "url", "optional", "doi", "optional", "category", 
